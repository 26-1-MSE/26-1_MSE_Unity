...
#### 3. C# 변수명
* Public, Protected 멤버 변수는 파스칼 케이스 사용 (예: public int PlayerNum;)
* Private 멤버 변수는 언더스코어 + 카멜 케이스 사용 (예: private int _playerNum;)
* Unity Serialized Field는 접근 제한자에 관계없이 카멜 케이스 사용
  * 예: ```[SerializeField] private GameObject playerObject;```
  * 예: ```[SerializeField] protected GameObject playerObject;```
